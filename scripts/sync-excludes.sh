...
SYNC_EXCLUDES=(
  ...
  --exclude=Obsidian
  --exclude='Documents/Obsidian*'
  --exclude=.obsidian
  --exclude='obsidian-*.md'
  --exclude='obsidian-*.json'
  --exclude='obsidian-*.log'
  --exclude='obsidian-*.txt'
  --exclude='Obsidian_*.md'
  --exclude=30-AI-Ingest
  --exclude=workspace-project-index.md
  --exclude=archive
