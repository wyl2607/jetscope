...
def _run_health_check(tmp_path: Path, *, readiness: str) -> subprocess.CompletedProcess[str]:
...
def test_not_ready_api_is_reported_unhealthy_even_when_liveness_is_200(tmp_path: Path):
