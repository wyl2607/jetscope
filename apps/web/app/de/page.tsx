      ...
      <section className="grid gap-5 lg:grid-cols-2 lg:grid-cols-3">
        <InfoCard title="Dashboard (DE)" subtitle="/de/dashboard">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/dashboard">
              Dashboard öffnen
            </Link>
          </p>
        </InfoCard>
        <InfoCard title="Deutschland Jet-Fuel Preise" subtitle="/de/prices/germany-jet-fuel">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/prices/germany-jet-fuel">
              Preisansicht öffnen
            </Link>
          </p>
        </InfoCard>
        <InfoCard title="Quellenprüfung" subtitle="/de/sources">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/sources">
              Quellen öffnen
            </Link>
          </p>
        </InfoCard>
        <InfoCard title="Szenario-Workbench" subtitle="/de/scenarios">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/scenarios">
              Szenarien prüfen
            </Link>
          </p>
        </InfoCard>
        <InfoCard title="Berichtswerkstatt" subtitle="/de/reports">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/reports">
              Berichte prüfen
            </Link>
          </p>
        </InfoCard>
        <InfoCard title="Forschungswerkstatt" subtitle="/de/research">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/research">
              Forschung prüfen
            </Link>
          </p>
        </InfoCard>
        <InfoCard title="Startbereitschaft" subtitle="/de/admin">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/admin">
              Bereitschaft prüfen
            </Link>
          </p>
        </InfoCard>
        <InfoCard title="Lufthansa-Analyse (DE)" subtitle="Tiefenanalyse">
          ...
          <p className="mt-4 text-sm">
            <Link className="text-accent underline hover:text-ink" href="/de/lufthansa-saf-2026">
              Zur Analyse (Deutsch) →
            </Link>
          </p>
        </InfoCard>
