...
// Run: node /Users/yumei/SAFvsOil/setup-faq.js
...
if (!fs.existsSync(faqDir)) {
  ...
  console.log('Created faq directory');
}
...
// Write the page
fs.writeFileSync(path.join(faqDir, 'page.tsx'), faqContent, 'utf-8');
console.log('✅ FAQ page created at', path.join(faqDir, 'page.tsx'));
