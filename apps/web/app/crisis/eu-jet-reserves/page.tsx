  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-4xl font-bold text-white">
              {formatNumber(reserve.weeks, 1)} <span className="text-lg font-medium text-slate-400">周</span>
            </p>
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="mt-2 flex justify-between text-xs text-slate-500">
              <span>0w</span>
              <span className="text-amber-400">2周（严重）</span>
              <span className="text-yellow-400">4周（偏高）</span>
              <span className="text-emerald-400">8周+（正常）</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-8 rounded-2xl border border-slate-800 bg-slate-900/60 p-8">
        <h2 className="text-xl font-semibold text-white">危机链条：储备 → 价格 → SAF 拐点</h2>
        <div className="mt-6 grid gap-6 md:grid-cols-4">
          <div className="rounded-lg border border-slate-700 bg-slate-950 p-5">
            <p className="text-xs font-semibold uppercase tracking-wider text-rose-300">步骤 1</p>
            <p className="mt-2 text-sm font-semibold text-white">储备消耗</p>
            <p className="mt-1 text-xs text-slate-400">
              EU 航油库存降至约 {formatNumber(reserve.weeks, 1)} 周。地缘扰动与炼化瓶颈共同推高压力。
            </p>
          </div>
          <div className="rounded-lg border border-slate-700 bg-slate-950 p-5">
            <p className="text-xs font-semibold uppercase tracking-wider text-amber-300">步骤 2</p>
            <p className="mt-2 text-sm font-semibold text-white">价格跳升</p>
            <p className="mt-1 text-xs text-slate-400">
              Jet-A 现货随稀缺性上行。当前 EU 代理价 ${formatNumber(jetEu, 3)}/L，高于 2024 年约 $0.75/L 的水平。
            </p>
          </div>
          <div className="rounded-lg border border-slate-700 bg-slate-950 p-5">
            <p className="text-xs font-semibold uppercase tracking-wider text-yellow-300">步骤 3</p>
            <p className="mt-2 text-sm font-semibold text-white">航线经济性承压</p>
            <p className="mt-1 text-xs text-slate-400">
              短途航线利润率被压缩（燃油约占成本 30%）。Lufthansa 已削减 20,000 个航班。
            </p>
          </div>
          <div className="rounded-lg border border-slate-700 bg-slate-950 p-5">
            <p className="text-xs font-semibold uppercase tracking-wider text-emerald-300">步骤 4</p>
            <p className="mt-2 text-sm font-semibold text-white">SAF 采购变得理性</p>
            <p className="mt-1 text-xs text-slate-400">
      ...
      <section className="mt-8 rounded-2xl border border-slate-800 bg-slate-900/60 p-8">
        <h2 className="text-xl font-semibold text-white">当前与压力情景下的 SAF 竞争力</h2>
          ...
          <table className="w-full text-sm text-slate-300">
            ...
            <tbody className="divide-y divide-slate-700">
              <tr>
                ...
                <td className="py-3 text-rose-400">SAF 经济性不足</td>
              </tr>
              <tr>
                <td className="py-3 pr-4 font-semibold text-white">$115/bbl（当前）</td>
                ...
                <td className="py-3 text-amber-400">拐点区间</td>
              </tr>
              <tr>
                ...
                <td className="py-3 text-yellow-400">边际切换</td>
              </tr>
              <tr>
                ...
                <td className="py-3 text-emerald-400">SAF 占优</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {/* Lufthansa context */}
      <section className="mt-8 rounded-2xl border border-slate-800 bg-slate-900/60 p-8">
        <h2 className="text-xl font-semibold text-white">Lufthansa 削减航班：领先指标</h2>
      ...
      <section className="mt-8">
        <InfoCard title="价格趋势背景" subtitle="1d / 7d / 30d — 与驾驶舱使用同一数据">
          <PriceTrendsChart
      ...
      {/* Action checklist */}
      <section className="mt-8 rounded-2xl border border-slate-800 bg-slate-900/60 p-8">
        <h2 className="text-xl font-semibold text-white">运营方决策清单</h2>
