...
function defaultReserveSignal(): ReserveSignal {
  return {
    ...
    // No verified gap % without env/official input — do not invent 25%.
    estimated_supply_gap_pct: null,
    source_type: 'manual',
    source_name: 'JetScope curated / env override (not IATA/EUROCONTROL live feed)',
    confidence_score: 0.4,
    supply_status_as_of: '2026-08-04',
    supply_status_note:
      'Lufthansa CEO (Stand 2026-08-04): aviation-fuel supply situation has normalized in recent weeks; article does not publish EU reserve days.'
  };
}
