...
| English | `/en`, `/en/dashboard`, `/en/sources` | English review slice for landing, decision cockpit, and source review; research, scenarios, reports, and admin still link back to the primary workspace until localized. |
